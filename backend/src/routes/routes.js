...
//Rotas users
router.post('/users', new CreateUserController_1.CreateUserController().handle); //cadastro
router.post('/session', new AuthUserController_1.AuthUserController().handle); //login
router.get('/me', isAuthenticated_1.isAuthenticated, new DetailUserController_1.DetailUserController().handle); //userInfo
//Rotas category
router.post('/category', isAuthenticated_1.isAuthenticated, new CreateCategoryController_1.CreateCategoryController().handle); //cadastro de categoria
router.get('/category', isAuthenticated_1.isAuthenticated, new ListCategoryController_1.ListCategoryController().handle); //categoryInfo
//Rotas products
